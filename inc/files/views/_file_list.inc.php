...
<table class="filelist table table-striped table-bordered table-hover table-condensed">
	...
	{ // Loop through all Files:
		...
		{ // User can edit:
			...
			echo action_icon( T_('Delete'), 'file_delete', regenerate_url( 'fm_selected', 'action=delete&amp;fm_selected[]='.rawurlencode( $lFile->get_rdfp_rel_path() ).'&amp;'.url_crumb('file') ) , NULL, NULL, NULL,
				array( 'onclick' => 'return confirm_file_delete( \''.regenerate_url( 'fm_selected', 'action=delete&amp;fm_selected[]='.rawurlencode( $lFile->get_rdfp_rel_path() ).'&amp;'.url_crumb('file') ).'\')') );
		}
		echo '</td>';
